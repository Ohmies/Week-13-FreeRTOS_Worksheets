...
void app_main(void)
{
    ...
    // เพิ่มการสาธิต Priority Inversion
    xTaskCreate(priority_inversion_high, "PrioInvHigh", 3072, NULL, 6, NULL); // Higher priority
    xTaskCreate(priority_inversion_low, "PrioInvLow", 3072, NULL, 2, NULL);   // Lower priority
